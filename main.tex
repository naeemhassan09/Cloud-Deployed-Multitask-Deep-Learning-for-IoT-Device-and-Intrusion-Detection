...
% Spacing between entries (tweak as desired)
\setlength{\bibitemsep}{0.6\baselineskip}

% Hanging indent that works regardless of class/list settings
\newlength{\mybibhang}
\setlength{\mybibhang}{1.5em}

\defbibenvironment{bibliography}
  {\list{}{%
     \setlength{\leftmargin}{\mybibhang}%
     \setlength{\itemindent}{-\mybibhang}%
...
% Clean, consistent font for refs (no full justification needed)
\renewcommand*{\bibfont}{\normalfont\normalsize}

% Heading as "References" for report class
